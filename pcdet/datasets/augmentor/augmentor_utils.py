...
def random_flip_along_x(gt_boxes, points, return_flip=False, enable=None, DA = False):
    """
    Args:
...
def random_flip_along_y(gt_boxes, points, return_flip=False, enable=None, DA = False):
    """
    Args:
        gt_boxes: (N, 7 + C), [x, y, z, dx, dy, dz, heading, [vx], [vy]]
        points: (M, 3 + C)
...
def global_rotation(gt_boxes, points, rot_range, return_rot=False, noise_rotation=None, DA = False):
    """
    Args:
        gt_boxes: (N, 7 + C), [x, y, z, dx, dy, dz, heading, [vx], [vy]]
        points: (M, 3 + C),
    ...
    ####################################################################################3
        ...
        if return_rot:
            return None, points, noise_rotation
        return None, points


def global_scaling(gt_boxes, points, scale_range, return_scale=False, DA = False):
    """
    Args:
    ...
    if DA is False:
        ...
        if return_scale:
            return None, points, noise_scale
        return None, points
